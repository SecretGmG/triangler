...
use crate::{Integrand, IntegrationResult, Integrator, Parametrization, Vec3};

impl Integrator<Complex64, (IntegrationResult, IntegrationResult)> for HavanaIntegrator {
    fn integrate(
        &self,
        integrand: &impl Integrand<Complex64>,
